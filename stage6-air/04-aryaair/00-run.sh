...
# dump1090-fa
install -v -m 755 files/enable_AryaAir-dump1090-fa.sh "${ROOTFS_DIR}/usr/local/sbin/"
...
# readsb
install -v -m 755 files/enable_AryaAir-readsb.sh   "${ROOTFS_DIR}/usr/local/sbin/"
install -v -m 644 files/readsb.service             "${ROOTFS_DIR}/home/pi/"
install -v -m 644 files/readsb-config.txt          "${ROOTFS_DIR}/boot/"
...
install -v -m 644 files/ADSBCOT.service     "${ROOTFS_DIR}/lib/systemd/system/"
