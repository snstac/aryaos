...
If you do not want Wi-Fi, pair a phone over Bluetooth. This choice can save the radio for sensors or reduce RF. AryaOS acts as a Bluetooth Network Access Point (NAP):
...
If you later reach a LAN, MANET. Alternatively, TAK Server, you can onboard the box onto that
network. Forward the picture upstream without losing the local Mesh SA picture:
