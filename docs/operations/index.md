...
!!! tip "Most of this lives on one page"
    Software updates, support bundles, the Node-RED password, and nearby nodes
    are cards on **Cockpit > [AryaOS Site](../admin/aryaos-site.md)**. You can
    operate this page with gloves. The pages in this section
