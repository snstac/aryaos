...
![AirTAK attached to a backpack](media/backpack.png){ width="640" }

On a sunny & warm June day in downtown San Diego, a range of 55 miles was achieved using this
configuration.

![ATAK AirTAK Screenshot](media/airtak_screenshot.jpg){ width="640" }


## How does AirTAK work?

![AirTAK CONOP](media/airtak_conop.png){ width="720" }
...
portable, turn-key device. When connected to a local or wide area network, AirTAK extends the operational coverage area and increases airspace situational awareness.
